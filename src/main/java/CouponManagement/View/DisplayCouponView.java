...
public class DisplayCouponView extends javax.swing.JFrame {

	public DisplayCouponView() {
		initComponents();
	}
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 758, Short.MAX_VALUE).addGroup(layout
						.createSequentialGroup().addGroup(layout.createParallelGroup(
								...
								.addGroup(
										layout.createSequentialGroup().addGap(305, 305, 305).addComponent(ExitButton)))
